...
## Debug
Objectif: afficher la page listant les items actuellement en base 
...
- Connexion.php > modif du nom des constantes pour le USER et le PASS
- ItemManager :
    - implements au lieu d'extends 
